...
Nesta seção são apresentadas as principais características dos bancos de dados NoSQL. Tais características conferem a estes bancos de dados os diferenciais que os tornam a opção preferencial para armazenamento e recuperação de dados com alto desempenho.
